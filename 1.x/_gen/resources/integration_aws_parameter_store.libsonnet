...
{
  '#':: d.pkg(name='integration_aws_parameter_store', url='', help='`integration_aws_parameter_store` represents the `doppler_integration_aws_parameter_store` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    type='doppler_integration_aws_parameter_store',
    label=resourceLabel,
  ...
  withAssumeRoleArn(resourceLabel, value): {
    resource+: {
      doppler_integration_aws_parameter_store+: {
        [resourceLabel]+: {

...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAccess':: d.fn(help='`doppler.service_token.withAccess` constructs a mixin object that can be merged into the `service_token`\nTerraform resource block to set or update the access field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `access` field.\n', args=[]),
  ...
  '#withConfig':: d.fn(help='`doppler.service_token.withConfig` constructs a mixin object that can be merged into the `service_token`\nTerraform resource block to set or update the config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `config` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`doppler.service_token.withName` constructs a mixin object that can be merged into the `service_token`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`doppler.service_token.withProject` constructs a mixin object that can be merged into the `service_token`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
